...
},
{
...
},
 {
  ...
  industry: "Sales",
  region: "Global",
  technologies: ["ASP.NET", "C#", "MySQL", "JavaScript"],
  features: ["Lead Management", "Agent Tracking", "Performance Reports"],
  description:
    "Agents & Leads is a comprehensive lead and team management platform designed to centralize lead distribution, campaign oversight, agent activities, and performance tracking. The system enables managers to assign leads, tasks, dealers, and brands to specific agents while monitoring daily, weekly, monthly, and yearly progress. With role-based permissions, multi-branch management, KPI dashboards, and detailed reports, the platform improves transparency, accountability, and decision-making across the complete office hierarchy.",
  teamSize: "5 members",
  serviceType: "Web",
  timeline: "10 months",
  techStack: techStackFrom("ASP.NET", "C#", "MySQL", "JavaScript", "Git", "Digital Ocean"),
  keyResults: keyResultsFrom(
